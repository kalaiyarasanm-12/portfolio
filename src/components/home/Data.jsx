...
const Data = () => {
  return (
      <div className="home__data">
            <h1 className="home__title">Kalaiyarasan M
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
          ...
          <p className="home__description">A motivated individual with in-depth knowledge of languages and development tools, seeking a position in a growth-oriented company where I can use my skills
              to the advantage of the company whilehaving the scope to develop my own skills.</p>
